...
def analyze_sentiment(review):
    final_result = list()
    for i in range(3):
       result = pipe[i](review)
       final_result.append(result[0])
    x, y, z = final_result[0]['label'], final_result[1]['label'], final_result[2]['label']
    if x == "positive" and y == "Positive" and z == "positif":
        resFinal = "Positif"
    elif x == "negative" and y == "Negative" and z == "negatif":
        resFinal = "Negatif"
    elif x == "neutral" and y == "Neutral" and z == "netral":
        resFinal = "Netral"
    elif x == "positive" and y == "Positive" and z != "positif":
        resFinal = "Positif"
    elif x == "positive" and y != "Positive" and z == "positif":
        resFinal = "Positif"
    elif x != "positive" and y == "Positive" and z == "positif":
...
query = "SELECT * FROM reviews WHERE review_text != '' AND (sentiment_1 is null OR sentiment_2 is null OR sentiment_3 is null ) ORDER BY id DESC LIMIT 1000"
